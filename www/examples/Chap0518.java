...
public class Chap0518 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Chapter 5 example 18: a PdfPTable at an absolute position");
        ...
        try {
            ...
            PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream("Chap0518.pdf"));
