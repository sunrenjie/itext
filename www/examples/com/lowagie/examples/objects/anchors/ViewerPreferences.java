...
public class ViewerPreferences extends PdfPageEventHelper {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// step 2:
			PdfWriter writer1 = PdfWriter.getInstance(document, new FileOutputStream("TwoColumnLeft.pdf"));
			PdfWriter writer2 = PdfWriter.getInstance(document, new FileOutputStream("HideMenuToolbar.pdf"));
			PdfWriter writer3 = PdfWriter.getInstance(document, new FileOutputStream("FullScreen.pdf"));
			// step 3:
            writer1.setViewerPreferences(PdfWriter.PageLayoutTwoColumnLeft);
            writer2.setViewerPreferences(PdfWriter.PageModeUseOutlines | PdfWriter.HideMenubar | PdfWriter.HideToolbar);
            writer3.setViewerPreferences(PdfWriter.PageLayoutTwoColumnRight | PdfWriter.PageModeFullScreen | PdfWriter.NonFullScreenPageModeUseOutlines);
			document.open();
            // step 4: we grab the ContentByte and do some stuff with it
            writer1.setPageEvent(new Bookmarks());
            writer2.setPageEvent(new Bookmarks());
            writer3.setPageEvent(new Bookmarks());
