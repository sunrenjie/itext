...
public class C0504_SimpleFonts {
    ...
    public void createPdf(String dest) throws IOException, DocumentException {
        ...
        bf = BaseFont.createFont("resources/fonts/cmr10.afm", BaseFont.WINANSI, BaseFont.EMBEDDED);
        canvas.setFontAndSize(bf, 12);
        canvas.newlineShowText("Inception");
        bf = BaseFont.createFont("resources/fonts/Puritan2.otf", BaseFont.CP1250, BaseFont.EMBEDDED);
        canvas.setFontAndSize(bf, 12);
        canvas.newlineShowText("Nikogar\u0161nja zemlja");
        bf = BaseFont.createFont("resources/fonts/OpenSans-Regular.ttf", "CP1253", BaseFont.EMBEDDED);
        canvas.setFontAndSize(bf, 12);
        canvas.newlineShowText("\u039d\u03cd\u03c6\u03b5\u03c2");
        bf = BaseFont.createFont("resources/fonts/OpenSans-Regular.ttf", "CP1251", BaseFont.EMBEDDED);
        canvas.setFontAndSize(bf, 12);
